...
export class TfgridModuleFarmingPolicyStoredEvent {
  ...
  get asLatest(): v68.FarmingPolicy {
    deprecateLatest()
    return this.asV68
  }
}
...
export class TfgridModulePricingPolicyStoredEvent {
  ...
  get asLatest(): v50.PricingPolicy {
    deprecateLatest()
    return this.asV50
  }
}
