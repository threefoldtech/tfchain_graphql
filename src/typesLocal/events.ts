...
export class BalancesTransferEvent {
   ...
   *  Transfer succeeded. \[from, to, value\]
   */
  get asV62(): [Uint8Array, Uint8Array, bigint] {
    assert(this.isV62)
...
export class SmartContractModuleContractGracePeriodEndedEvent {
  ...
  get asV62(): [bigint, number, number] {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
...
export class SmartContractModuleContractGracePeriodStartedEvent {
  ...
  get asV62(): [bigint, number, number, bigint] {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
...
export class SmartContractModuleNruConsumptionReportReceivedEvent {
  ...
  get asLatest(): v62.NruConsumption {
    deprecateLatest()
    return this.asV62
  }
}
...
export class SmartContractModuleUpdatedUsedResourcesEvent {
  ...
  get asV62(): v62.ContractResources {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): v62.ContractResources {
    deprecateLatest()
    return this.asV62
  }
}
...
export class TfgridModuleNodePublicConfigStoredEvent {
  ...
  get asV62(): [number, v62.PublicConfig] {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): [number, v62.PublicConfig] {
    deprecateLatest()
    return this.asV62
  }
}
...
export class TfgridModuleNodeUptimeReportedEvent {
  ...
  get asV62(): [number, bigint, bigint] {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
...
export class TfgridModulePricingPolicyStoredEvent {
  ...
  get asLatest(): v62.PricingPolicy {
    deprecateLatest()
    return this.asV62
  }
}
...
export class TfgridModuleTwinEntityStoredEvent {
  ...
  get asV62(): [number, number, Uint8Array] {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
...
export class TftBridgeModuleBurnTransactionProcessedEvent {
  ...
  get asLatest(): v62.BurnTransaction {
    deprecateLatest()
    return this.asV62
  }
}
...
export class TftBridgeModuleMintCompletedEvent {
  ...
  get asLatest(): v62.MintTransaction {
    deprecateLatest()
    return this.asV62
  }
}
...
export class TftBridgeModuleRefundTransactionProcessedEvent {
  ...
  get asV62(): v62.RefundTransaction {
    assert(this.isV62)
    return this.ctx._chain.decodeEvent(this.ctx.event)
  }
  ...
  get asLatest(): v62.RefundTransaction {
    deprecateLatest()
    return this.asV62
  }
}
