...
export class TfgridModuleNodeStoredEvent {
  ...
  get isV119(): boolean {
    return this.ctx._chain.getEventHash('tfgridModule.NodeStored') === '8ae1f1782f669f4f37b4030e0f551e82382d85d766d0f9fc9d968830285fd8b4'
  }
...
export class TfgridModuleNodeUpdatedEvent {
  ...
  get isV119(): boolean {
    return this.ctx._chain.getEventHash('tfgridModule.NodeUpdated') === '8ae1f1782f669f4f37b4030e0f551e82382d85d766d0f9fc9d968830285fd8b4'
  }
