module.exports = class power_mgnmt1670929041289 {
  name = 'power_mgnmt1670929041289'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "deployment_resources" ("id" character varying NOT NULL, "hru" numeric NOT NULL, "sru" numeric NOT NULL, "cru" numeric NOT NULL, "mru" numeric NOT NULL, "contract_id" character varying NOT NULL, CONSTRAINT "REL_110ad3a72d8cd9fc5a3d72dd83" UNIQUE ("contract_id"), CONSTRAINT "PK_c6e3a69f7b9bb63ccc82e4ef213" PRIMARY KEY ("id"))`)
    await db.query(`CREATE UNIQUE INDEX "IDX_110ad3a72d8cd9fc5a3d72dd83" ON "deployment_resources" ("contract_id") `)
    await db.query(`CREATE TABLE "deployment" ("id" character varying NOT NULL, "deployment_id" numeric NOT NULL, "twin_id" integer NOT NULL, "capacity_reservation_id" numeric NOT NULL, "deployment_data" text NOT NULL, "deployment_hash" text NOT NULL, "number_of_public_i_ps" integer NOT NULL, "public_ips" jsonb, "created_at" numeric NOT NULL, CONSTRAINT "PK_ee1f952fc81f37c6fea69c2e248" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "executed_contract_migration" ("id" character varying NOT NULL, "executed" boolean NOT NULL, CONSTRAINT "PK_077e46ae293bde9d377ebfbc7ea" PRIMARY KEY ("id"))`)
  ...
  async down(db) {
    ...
    await db.query(`DROP TABLE "executed_contract_migration"`)
