module.exports = class power_management1668677826274 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "deployment_contract_resources" ("id" character varying NOT NULL, "hru" numeric NOT NULL, "sru" numeric NOT NULL, "cru" numeric NOT NULL, "mru" numeric NOT NULL, "contract_id" character varying NOT NULL, CONSTRAINT "PK_a4dd4a9907279eb36ff32281e8a" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_d112ff4f45cfd4fe655dd60f7c" ON "deployment_contract_resources" ("contract_id") `)
    await db.query(`CREATE TABLE "deployment_contract" ("id" character varying NOT NULL, "contract_id" numeric NOT NULL, "twin_id" integer NOT NULL, "capacity_reservation_id" numeric NOT NULL, "deployment_data" text NOT NULL, "deployment_hash" text NOT NULL, "number_of_public_i_ps" integer NOT NULL, "public_ips" jsonb, "state" character varying(11) NOT NULL, "created_at" numeric NOT NULL, "solution_provider_id" integer, "resources_used_id" character varying, CONSTRAINT "PK_a6eb6232afec32ef8d89a9e348e" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_eca3b438281ab192e16373473e" ON "deployment_contract" ("resources_used_id") `)
    ...
    await db.query(`ALTER TABLE "deployment_contract_resources" ADD CONSTRAINT "FK_d112ff4f45cfd4fe655dd60f7c4" FOREIGN KEY ("contract_id") REFERENCES "deployment_contract"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "deployment_contract" ADD CONSTRAINT "FK_eca3b438281ab192e16373473ef" FOREIGN KEY ("resources_used_id") REFERENCES "deployment_contract_resources"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  }
  ...
  async down(db) {
    ...
    await db.query(`ALTER TABLE "deployment_contract_resources" DROP CONSTRAINT "FK_d112ff4f45cfd4fe655dd60f7c4"`)
    await db.query(`ALTER TABLE "deployment_contract" DROP CONSTRAINT "FK_eca3b438281ab192e16373473ef"`)
  }
}
