module.exports = class Data1647884483478 {
  name = 'Data1647884483478'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "node" ("id" character varying NOT NULL, "grid_version" integer NOT NULL, "node_id" integer NOT NULL, "farm_id" integer NOT NULL, "twin_id" integer NOT NULL, "country" text, "city" text, "hru" numeric, "sru" numeric, "cru" numeric, "mru" numeric, "public_config" jsonb, "uptime" integer, "created" integer NOT NULL, "farming_policy_id" integer NOT NULL, "certification_type" character varying(9) NOT NULL, "secure" boolean, "virtualized" boolean, "serial_number" text, "location_id" character varying NOT NULL, CONSTRAINT "PK_8c8caf5f29d25264abe9eaf94dd" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "node_contract" ("id" character varying NOT NULL, "version" integer NOT NULL, "contract_id" integer NOT NULL, "twin_id" integer NOT NULL, "node_id" integer NOT NULL, "deployment_data" text NOT NULL, "deployment_hash" text NOT NULL, "number_of_public_i_ps" integer NOT NULL, "state" character varying(10) NOT NULL, "resources_used" jsonb, CONSTRAINT "PK_a5f90b17f504ffcd79d1f66574a" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "uptime_event" ("id" character varying NOT NULL, "node_id" integer NOT NULL, "uptime" integer NOT NULL, "timestamp" integer NOT NULL, CONSTRAINT "PK_90783463b0d0b660367ebd7f5ff" PRIMARY KEY ("id"))`)
